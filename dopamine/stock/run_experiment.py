...
from dopamine.stock import preprocessing
  ...
  def _run_one_step(self, action):
    ...
    Returns:
      The observation, reward, and is_terminal values returned from the
        environment.
    """
    observation, reward, is_terminal = self._environment.step(action)
...
class TrainRunner(Runner):
  ...
  def _run_one_iteration(self, iteration):
    ...
    # num_episodes_train, average_reward_train = self._run_train_phase(
    #     statistics)
    num_episodes_train, average_reward_train = self._run_eval_phase(
      statistics)
